...
const totalKilos = collectionHistory.reduce((s, c) => s + c.kilos, 0);
const totalPoints = collectionHistory.reduce((s, c) => s + c.points, 0);

export default function HistoryScreen() {
  const groupedByDate = collectionHistory.reduce((acc, item) => {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.summaryRow}>
          ...
          <View style={styles.summaryItem}>
            ...
            <Text style={styles.summaryValue}>{collectionHistory.length}</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        {Object.entries(groupedByDate).map(([date, items]) => (
          <View key={date} style={styles.dateGroup}>
            <Text style={styles.dateLabel}>{dateLabels[date] || date}</Text>
            {items.map((item) => (
